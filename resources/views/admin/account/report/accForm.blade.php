              ...
              <div class="card">                                
                <div class="row">
                  <div class="col-md-6 col-xs-12">
                      ...
                      <input autofocus="" type="text" placeholder="Account Name" class="form-control" name="name" value="{{old('account_name')}}" required>
                    </div> 
                  </div>        
                  ...
                  <div class="col-md-3 col-xs-6">
                    <div class="form-group ">
                      <label>Account Code<span style="color:#b12f1f;">*</span></label>
                       <input type="text" name="code" class="form-control" placeholder="1000" value="{{old('contact_name')}}" >
                    </div>
                </div>
                <div class="col-md-3 col-xs-6">
                    <div class="form-group ">
                      <label>Account Description<span style="color:#b12f1f;">*</span></label>
                       <input type="text" name="account_desc" class="form-control" placeholder="1000" value="{{old('contact_name')}}" >
                    </div>
                </div>
                <div class="col-md-3 col-xs-6">
                <div class="form-group ">
