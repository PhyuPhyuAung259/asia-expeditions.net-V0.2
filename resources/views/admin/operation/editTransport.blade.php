                                ...
                                <div class="row">
                                    <div class="col-md-12 col-xs-12">
                                        <div class="form-group">
                                            ...
                                            <input type="date" id="start_date" name="start_date" class="form-control book_date" placeholder="Start Date" value="{{$editTran->start_date}}" >	
                                        </div> 
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="country" name="country" required>
                                            ...
                                            @if($editTran->country_id !== null)
                                                <option value="{{$editTran->country_id}}">   <?php  $country = DB::table('country')->where('id', $editTran->country_id)->first();?> {{$country->country_name}}	</option>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="transport">
                                            @if($editTran->transport_id !== null)
                                                <option value="{{$editTran->transport_id}}">   <?php  $supplier = DB::table('suppliers')->where('id', $editTran->transport_id)->first();?> {{$supplier->supplier_name}}	</option>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="tran_name" >
                                          @if($editTran->service_id !== null)
                                                <option value="{{$editTran->service_id}}">   <?php  $transervice = DB::table('transport_service')->where('id', $editTran->service_id)->first();?> {{$transervice->title}}	</option>
                                                @foreach(App\Supplier::where(['business_id'=> 7, 'supplier_status'=>1, 'country_id'=> $editTran->country_id])->orderBy('supplier_name', 'ASC')->get() as $sup)
                                                    <option value="{{$sup->id}}">{{$sup->supplier_name}}</option>
                                                @endforeach
                                            @endif
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control vehicle" name="vehicle" >
                                                @if($editTran->vehicle_id !== null)
                                                    <option value="{{$editTran->vehicle_id}}">   <?php  $vehicle = DB::table('transport_type')->where('id', $editTran->vehicle_id)->first();?> {{$vehicle->name}}	</option>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="price" id="price" class="form-control" placeholder="00.0" readonly>
                                    </div>
                                    </div>
                                    <div class="col-md-4 col-xs-3">
                                    <div class="form-group">
                                        <label>Price {{Content::currency(1)}}</label>
                                        <input type="text" name="kprice" id="kprice" class="form-control" placeholder="00.0" readonly>
                                    </div>
                                    </div>       
                                    ...
                                    <div class="col-md-2 col-xs-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control driver_name" name="driver_name">
