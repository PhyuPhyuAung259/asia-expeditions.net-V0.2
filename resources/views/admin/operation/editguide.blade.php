                                        ...
                                        <div class="row">
                                            <div class="col-md-12 col-xs-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="date" name="start_date" class="form-control" placeholder="Start Date" value="{{$guide->start_date}}">	
                                                </div> 
                                            </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control tran_name" name="tran_name" data-type="apply_language"  id="dropdown-apply_guide">
                                                    ...
                                                    <option value="$guide->service_id"> <?php  $service = DB::table('guide_service')->where('id', $guide->service_id)->first();?> {{$service->title}}</option>
                                                    <?php
                                            ...
                                            <div class="col-md-6 col-xs-6">
                                                <div class="form-group">
                                                    ...
                                                    @if($guide->service_id !== null)
                                                        <option value="$guide->language_id"> <?php  $lang = DB::table('guide_language')->where('id', $guide->language_id)->first();?> {{$lang->name}}</option>
                                                        <?php
