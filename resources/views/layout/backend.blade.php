...
<body class=" skin-green sidebar-mini sidebar-collapse">
    ...
    <a id="goTotop" class="hidden-print"
        style="position: fixed; right: 19px; display: none; bottom: 0px; font-size: 35px; z-index: 999999999;"
        href="javascript:void(0)"><span class="fa fa-chevron-circle-up"></span></a>
